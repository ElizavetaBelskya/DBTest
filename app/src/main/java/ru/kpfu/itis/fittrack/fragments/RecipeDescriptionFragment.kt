...
class RecipeDescriptionFragment : Fragment(R.layout.fragment_recipe_description) {
    var r: List<Recipe>? = ArrayList<Recipe>()
    var l: Recipe? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        r = RecipeDatabase.getDatabase(requireContext()).recipeDao().getAllRecipes().value
        l = r?.get(id)
        ...
        binding.tvFats.text = "Fats: ${l?.fats}"
        binding.tvCarbo.text = "Carbohydrates: ${l?.carbohydrates}"
